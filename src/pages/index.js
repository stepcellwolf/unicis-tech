...
import home from "../images/undraw_multitasking_unicis.png";
      ...
      >
        <div className="w-4/5 md:w-3/4 lg:w-7/12 mt-20 font-serif font-hairline self-start">
          ...
          <p className="text-base">
            One and only one Governance, Risk and Compliance (GRC) tool integrated with your Atlassian services that you need to meet security and privacy requirements for your business.
          </p>
        </div>
